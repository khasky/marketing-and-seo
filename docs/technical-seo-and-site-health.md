[← SEO — FAQ, keywords, and tools](seo-tools-and-faq.md) · [AI search and GEO →](ai-search-and-geo.md)
...
| Prev                                                   | Up               | Next                                                          |
| ------------------------------------------------------ | ---------------- | ------------------------------------------------------------- |
| [SEO — FAQ, keywords, and tools](seo-tools-and-faq.md) | [Home](index.md) | [AI search and GEO](ai-search-and-geo.md) |
